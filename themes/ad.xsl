...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0" 
  ...
  <xsl:template match="/body[contains(@class, 'agregator')]//div[contains(@class, 'part')][last() - position() &gt; 2][position() mod 3 = 2]//h2">
      ...
      <div class="list"><ul class="ad">
        <xsl:choose>
          ...
          <xsl:when test="$rand = 2">
            ...
            <li><a href="#ebook" class="button button--simple button--img button--img-inline"><span class="fas fa-fw fa-atlas">i</span> E-book nebo PDF</a></li>
          </xsl:when>
          ...
          <xsl:when test="$rand = 6">
            ...
            <li><a href="#ebook" class="button button--simple button--img button--img-inline"><span class="fas fa-fw fa-atlas">i</span> Elektronická kniha</a></li>
          </xsl:when>
        </xsl:choose>
      </ul></div>
    </xsl:if>
