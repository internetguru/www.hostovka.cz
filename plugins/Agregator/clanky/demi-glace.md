...
Zaprvé budete potřebovat:
  ...
  * 4 šálky hnědé omáčky, francouzsky zvané _Sauce Espagnole {xml:lanf="fr"}_,
...
Hnědá omáčka _(Sauce Espagnole) {xml:lanf="fr"}_

  * ½ šálku hovězího nebo telecího tuku (_beef or veal drippings {xml:lanf="en"}_),
  * 1 šálek _Mirepoix {xml:lanf="fr"}_ (viz níže),
  * ½ šálku hladké mouky,
  * 10 zrnek černého pepře,
  * 2 šálky nadrobno sekaných loupaných rajčat bez semen a šťávy _(concassée) {xml:lanf="fr"}_,
  * ½ šálku hrubě sekané zelené petrželky,
  * 8 šálků dobrého hovězího vývaru.

Postup

  1. V pánvi se silným dnem zahřejeme tuk. Přidáme 1 šálek _mirepoix {xml:lanf="fr"}_ (níže).
...
Zelenina nemusí být loupaná, ale musí být dobře očištěná a opraná. Po očištění zeleninu nakrájíme na hrubé kousky _(mirepoix) {xml:lanf="fr"}_ které nemusí být pravidelných tvarů, ale měly by být o přibližně stejné velikosti.
