...
{id="podavani_jidel" ctime="2007-05-05" author="Michael Klíma" short="Podávání jídel" mtime="2019-10-25"}
...
## Podávání jídel před zraky hostů
...
Pro hosty je tento typ podávání jídel součástí zábavy, nebo chcete-li [zážitkovou gastronomií][6]. Host se cítí do přípravy svého jídla do jisté míry zapojen, protože má možnost si vybrat potraviny a dochucení podle své preference. To ale také předpokládá, že má host alespoň nějaké základní znalosti o surovinách a technologiích přípravy jídel.

{class="important"}

Tento způsob podávání jídla ale vyžaduje nejenom zručnost, ale i přísné dodržování hygieny a bezpečnosti práce. O osobní hygieně ani nemluvě. 
...
Na vhodné nádobí se zapomíná již při tvorbě jídelního lístku. To, že „jídla pro dva“ musí být podávána na velkých mísách spolu s teplým nebo studeným talířem pro každého hosta, se na našich hotelových školách zřejmě neučí. Je ale možné, že se pletu.
...
Používání nadměrně velkých talířů má svůj limit. Nejsou na to žádné tabulky, tudíž je nutné se spoléhat na vlastní cit. Prostě porce některých jídel jsou tak velké, že by se na normální talíř nevešly. Některé porce jsou tak velké, že se nedají jíst ani na velkém talíři. Tak vám zpravidla přinesou další talíř, ze kterého pak můžete jíst.
...
Dnes to ale nejsou jen talíře, na kterých se jídla podávají. Čím dále více populární je podávání teplých jídel na dřevěných prkénkách. Že by to ale bylo estetické nebo dokonce praktické se ale říci nedá.
...
Hygieničtější a atraktivnější podávání jídel než na dřevěných prkénkách je na litinových pánvičkách (anglicky zvaných _cast iron {xml:lang="en"}_ nebo _sizzler plates {xml:lang="en"}_). Když se takové jídlo podává na stůl, tak stále ještě syčí a prská. Tím získává atraktivní vizuální vjem, který je doplněn vůní.
 ...
 [3]: /banket
 [4]: /garde_manager
 [5]: /hotovky_a_minutky#studene_talire
 [6]: /modni_pojmy
 [7]: /brunch
 [8]: /sotyrovani
